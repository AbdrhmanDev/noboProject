...
const financials = [
  { label: "إجمالي الإيرادات", value: "125,430", color: "#2b8cff", icon: TrendingUp },
  { label: "إجمالي المصروفات", value: "96,890", color: "#ff3d6b", icon: TrendingDown },
  { label: "صافي الربح", value: "28,540", color: "#17d9c4", icon: Wallet },
  { label: "الرصيد البنكي", value: "486,200", color: "#f5b800", icon: Landmark },
];
  ...
  return (
    <AppLayout onLogout={onLogout} activePath={ROUTES.ACCOUNTING}>
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <h1 className="text-xl font-black brand-text">المحاسبة</h1>
        <button className="primary-btn rounded-xl px-3 py-2 text-xs font-bold flex items-center gap-1"><Plus size={13} /> قيد جديد</button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {financials.map((f, i) => (
          <div key={i} className="stat-card rounded-2xl p-4">
            ...
            <div className="text-[11px] text-gray-400 mt-1">{f.label}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.6fr_1fr] gap-4">
        ...
        <div className="panel rounded-2xl p-4">
          <h3 className="font-bold text-sm mb-3">الحركات المالية الأخيرة</h3>
          <table className="w-full text-xs">
            <thead>
              <tr className="text-gray-500 text-right">
                <th className="font-medium pb-2">التاريخ</th>
                <th className="font-medium pb-2">البيان</th>
        ...
        {/* summary widget */}
        <div className="panel rounded-2xl p-4">
          <h3 className="font-bold text-sm mb-3">ملخص الحسابات</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-300">الأصول</span>
              <span className="font-bold text-blue-400">648,300 ر.س</span>
            </div>
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-300">الخصوم</span>
              <span className="font-bold text-red-400">112,460 ر.س</span>
            </div>
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-300">حقوق الملكية</span>
              <span className="font-bold text-green-400">535,840 ر.س</span>
            </div>
            <div className="border-t border-white/10 pt-3">
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-300">نسبة السيولة</span>
