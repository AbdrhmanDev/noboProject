...
// Generic feature-scoped dialog shell -- mirrors ProcurementModal/InventoryModal exactly (each
// feature owns its own modal shell in this codebase rather than sharing one across features).
export function PlatformModal({ title, children, onClose, size = "md" }) {
