...
// Generic feature-scoped dialog shell, deliberately not the POS-owned
// PosModal (that one is wired into POS's own shortcut-scope registry, which
// this feature must not touch). Mirrors the same visual language already
// used by InventoryModal elsewhere in the app.
export function RestaurantModal({ title, children, onClose, size = "md" }) {
