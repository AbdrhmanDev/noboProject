...
// NOBO-styled confirmation — used wherever this feature needs a real
// confirm step (Release Table, Cancel Reservation, No Show) instead of
// window.confirm.
export function ConfirmActionDialog({
  ...
  return (
    <RestaurantModal title={title} onClose={onClose}>
      <div className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          >
            {t("restaurantFloor.actions.cancel")}
          </button>
          <button
            type="button"
            onClick={onConfirm}
          ...
          >
            {isPending ? t("restaurantFloor.actions.saving") : confirmLabel}
          </button>
        </div>
      </div>
    </RestaurantModal>
