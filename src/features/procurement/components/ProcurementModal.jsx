...
// Generic feature-scoped dialog shell — mirrors InventoryModal/RestaurantModal
// (deliberately not the POS-owned PosModal, which is wired into POS's own
// shortcut-scope registry that this feature must not touch).
export function ProcurementModal({ title, children, onClose, size = "md" }) {
